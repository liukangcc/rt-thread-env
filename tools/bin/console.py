...
path = os.getcwd()+ "/tools/git/Git/bin" + ';' + os.getcwd()+ "/tools/bin" + ';'+ os.getcwd() + "/tools/Python38"+ ';' + os.getcwd() + "/tools/Python38/Scripts"+';'+ os.getcwd() + "/tools/qemu" +';' + os.getcwd()+ "/tools/qemu/qemu32" + ';' + os.environ["PATH"]
...
os.environ["SCONS"] = os.getcwd() + "/tools/Python38/Scripts"
